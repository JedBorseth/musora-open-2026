...
function WelcomePage() {
  ...
  return (
    <>
      ...
      <footer className="mx-auto w-full max-w-md px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-4">
        <div className="flex flex-col items-center justify-center gap-2 rounded-2xl px-4 py-3 text-center text-xs text-muted-foreground">
          <p className="text-balance leading-relaxed">
            Built by{' '}
            <FooterLink href="https://github.com/JedBorseth">
              Jed Borseth
            </FooterLink>{' '}
            for the Musora Open.
          </p>
          <div className="flex flex-col items-center justify-center gap-2">
            <FooterButton href="https://github.com/JedBorseth/musora-open-2026">
              View this repo
            </FooterButton>
            <FooterButton href="https://github.com/JedBorseth">
...
function FooterButton({
  ...
  return (
    <a
      ...
      className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-background/80 px-3 py-1.5 font-medium text-foreground shadow-xs transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 sm:w-auto"
    >
      {children}
      <SquareArrowOutUpRightIcon className="size-3" aria-hidden />
    </a>
  )
}
...
function FooterLink({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="font-medium text-foreground underline-offset-4 transition-colors hover:text-emerald-700 hover:underline dark:hover:text-emerald-300"
    >
      {children}
    </a>
  )
